...
<head>
    ...
    <title>Eddy and Eline</title>
    <link href="https://fonts.googleapis.com/css?family=Berkshire+Swash|Coustard|Dancing+Script|Fugaz+One|Galada|Gloria+Hallelujah|Indie+Flower|Irish+Grover|Lobster|Marko+One|Pacifico|Rock+Salt|Satisfy"
          rel="stylesheet">
...
<nav class="navbar navbar-expand-lg main-navbar">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="img/elineddy/logo1.png" alt="Logo">
        </a>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 col-md-12 col-12 col-sm-12">
                        ...
                        <p class="G-information_header_body">Den 10. november 2014 blev vi gift i Havana, Cuba. Eddy's
                            ...
                            <br> Vi har derfor booket Simon som kommer med sin rullende restaruant og serverer peruvianske streetfood. Vi
                            sørger
        ...
        <div class="row">
            <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12 info">
                ...
                <div class="list-item bg_features_internal_maergin">
                    <div class="desc">
                        <h2><i class="ion-calendar"></i> Dato / Tidspunkt </h2>
                        <p>
                        <ul>
                            <li>Den 2. juni 2018. Mød op i kirken kl.14:35 - velsignelsen starter klokken 15:00</li>
                            <li>Efter kirken er der 3 minutters gang til skolen hvor vi holder festen</li>
                        </ul>
                        </p>
                ...
                <div class="list-item bg_features_internal_maergin">
                    <div class="desc">
                        <h2><i class="ion-android-pin"></i> Sted</h2>
                        <ul>
                            <li>
                                Store Magleby Kirke, Kirkevej 6, 2791 Dragør
                            </li>
                        </ul>
                        <div style="margin: 5px">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m27!1m12!1m3!1d2254.3824967079845!2d12.634160416259663!3d55.59535648051154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m12!3e3!4m4!1s0x4653aafd862a3665%3A0xb7ae1f4c75bd50c1!3m2!1d55.595932399999995!2d12.636911399999999!4m5!1s0x4653aafd862a3665%3A0xb7ae1f4c75bd50c1!2sStore+Magleby+Church%2C+Kirkevej+6%2C+2791+Drag%C3%B8r!3m2!1d55.595932399999995!2d12.636911399999999!5e0!3m2!1ses!2sdk!4v1516554253996"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-xl-6 col-md-12 info">
                <div class="projects-details">
                    ...
                    <p> Vielse/velsignelse<br></p>

                    <h4>
                        <small>16:00</small>
                        Store Magleby Skole
                    </h4>
                    <p> Velkomstdrink og snacks<br>
                        Festlige indslag, musik og hygge<br>
                        Bryllupskage og asti/bobler<br>
                        Brudevals alias latinovals<br>
                        Hvis du har et festligt indslag, så tal med toastmaster onkel Per Johnsen.<br></p>

                    <h4>
                        <small> 18:30</small>
                        Mad
                    </h4>
                    <p>Panca’s rullende restaurant serverer lækker mad<br>
                        Ingen bordplan. Free seating!<br>
                        Plads til festlige indslag.<br></p>

                    <h4>
                        <small>19:30</small>
                        Live underholdning
                    </h4>
                    <p>Latinband – så skal der danses!<br>
            ...
            <div class="row col-spacing">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <p class="section-lead text-center text-muted">Meld venligst hurtigt tilbage om du kan
                        komme!</p>
                    <p>
                        Tilmeldelse til brylluppet foregår via Mobilepay inden den 1. maj. Men meget gerne
                        før/så hurtigt som
